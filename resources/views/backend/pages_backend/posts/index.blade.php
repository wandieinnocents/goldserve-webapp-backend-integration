                    ...
                    <tbody>
                        ...
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-body">{{ $post->post_category_r->post_category_name }}
                                    </a>
                                </td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                                data-bs-target="#viewDetails{{ $post->id }}"
                                                data-bs-whatever="@getbootstrap"><i class=" far fa-eye  "></i></button>
                                        </div>

                                        <div class="col-md-4">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#editPostOrder{{ $post->id }}"
                            ...
                            <!-- VIEW DETAILS MODEL -->
                            <div class="modal fade" id="viewDetails{{ $post->id }}" tabindex="-1"
                                aria-labelledby="viewDetailsLabel" style="display: none;" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#editPostOrder{{ $post->id }}"
                                                data-bs-whatever="@getbootstrap">Edit post</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="editPostOrder{{ $post->id }}" tabindex="-1"
                                aria-labelledby="editPostOrderLabel" style="display: none;" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('posts.update', $post->id) }}" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="post_created_by"
                                                        id="validationCustom02" disabled placeholder="Created By"
                                                        value="{{ $loggedinUser }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="recipient-name" class="col-form-label">Name:</label>
                                                    <input type="text" class="form-control" name="post_title"
                                                        value="{{ $post->post_title }}" id="recipient-name">
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="validationCustom05">Photo</label>
                                                        <input type="file" class="form-control" name="post_photo"
                                                            value="{{ $post->post_photo }}" placeholder="Zip">
